...
import Docker, { DockerHome } from "./Docker";
import { Froles } from "@/lib/font";

export default function Nav() {
  return (
    <div className="top-0 md:bottom-0 left-0 z-50 flex flex-col md:flex-row md:gap-0 gap-4 md:justify-evenly w-full p-4 md:pb-12 text-white items-center">
      <p
